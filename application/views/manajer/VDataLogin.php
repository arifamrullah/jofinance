    ...
    <div class="right">
        ...
        <table style="margin:10px 0 20px;width:100%;">
            <tr>
                <td>
                    <div id="search">
                        <form action="<?php echo base_url(); ?>index.php/manajer/CDataLogin/search" method="post">
                            <input type="text" name="keyword" id="keyword" title="Masukkan Kata Kunci" placeholder="Cari Username" class="txt_field" />
        ...
        ?>
                <table class="CSSTableGenerator">
                    ...
                    <tr>
                        ...
                        <td><?php echo $data->login_terakhir; ?></td>
                        <td><?php echo $data->logout_terakhir; ?></td>
                        <td>
