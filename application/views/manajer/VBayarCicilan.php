    ...
    <div class="right">
        <h1>Data Bayar Cicilan</h1>
            <table style="margin:10px 0 20px;width:100%;">
                <tr>
                    <td>
                        <div id="search">
                            <form action="<?php echo base_url(); ?>index.php/manajer/CBayarCicilan/search" method="post">
        ...
        <table class="CSSTableGenerator" cellpadding="5">
            ...
            <tr>
                ...
                <td>
                    <a class="hapus" title="Hapus" href = "<?php echo base_url(); ?>index.php/manajer/CBayarCicilan/delete/<?php echo $data->kode_cicilan; ?>" onClick="return confirm('Apakah Anda Yakin?');"></a>
                </td>
            </tr>
            <?php
                $no++;
