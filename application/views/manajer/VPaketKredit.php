    ...
    <div class="right">
        <h1>Data Paket Kredit</h1>
            <table style="margin:10px 0 20px;width:100%;">
                <tr>
                    <td>
                        <div id="search">
                            <form action="<?php echo base_url(); ?>index.php/manajer/CPaketKredit/search" method="post">
        ...
        <table class="CSSTableGenerator">
            ...
            <tr>
                ...
                <td>
                    <a class="hapus" title="Hapus" href = "<?php echo base_url(); ?>index.php/manajer/CPaketKredit/delete/<?php echo $data->kode_paket; ?>" onClick="return confirm('Apakah Anda Yakin?');"></a>
                </td>
            </tr>
            <?php
                $no++;
