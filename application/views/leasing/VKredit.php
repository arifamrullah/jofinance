    ...
    <div class="right">
        <h1>Data Kredit</h1>
            <table style="margin:10px 0 20px;width:100%;">
                <tr>
                    <td>
                        <div id="search">
                            <form action="<?php echo base_url(); ?>index.php/leasing/CKredit/search" method="post">
        ...
        <table class="CSSTableGenerator">
            ...
            <tr>
                ...
                <td>
                    <a class="ubah" title="ubah" href = "<?php echo base_url(); ?>index.php/leasing/CKredit/update/<?php echo $data->kode_kredit; ?>"></a>
                </td>
                <td>
                    <a class="hapus" title="hapus" href = "<?php echo base_url(); ?>index.php/leasing/CKredit/delete/<?php echo $data->kode_kredit; ?>" onClick="return confirm('Apakah Anda Yakin?');"></a>
                </td>
            </tr>
            <?php
                $no++;
