    ...
    <div class="right">
        <h1>Data Paket Kredit</h1>
            <table style="margin:10px 0 20px;width:100%;">
                <tr>
                    <td>
                        <div id="search">
                            <form action="<?php echo base_url(); ?>index.php/petugas/CPaketKredit/search" method="post">
        ...
        <table class="CSSTableGenerator" cellpadding="5">
            ...
            <tr>
                ...
                <td>
                    <a class="ubah" title="Ubah" href = "<?php echo base_url(); ?>index.php/petugas/CPaketKredit/update/<?php echo $data->kode_paket; ?>"></a>
                </td>
                <td>
                    <a class="hapus" title="Hapus" href = "<?php echo base_url(); ?>index.php/petugas/CPaketKredit/delete/<?php echo $data->kode_paket; ?>" onClick="return confirm('Apakah Anda Yakin?');"></a>
                </td>
            </tr>
            <?php
                $no++;
